...
filename = "/home/dlagroup25/group8/weights-improvement-200-0.3272.hdf5"
...
print("test_top_2_accuracy:",score[2])
print("test_top_3_accuracy:",score[3])
...
model_json = designed_model.to_json()
with open("designed_model.json", "w") as json_file:
  json_file.write(model_json)
designed_model.save_weights("designed_model.h5")
